...
/***/ "./node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/_deps/vscode-languageserver-types/main.js":
/*!*************************************************************************************************************************************!*\
  !*** ./node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/_deps/vscode-languageserver-types/main.js ***!
  \*************************************************************************************************************************************/
/*! exports provided: Position, Range, Location, LocationLink, Color, ColorInformation, ColorPresentation, FoldingRangeKind, FoldingRange, DiagnosticRelatedInformation, DiagnosticSeverity, DiagnosticTag, Diagnostic, Command, TextEdit, TextDocumentEdit, CreateFile, RenameFile, DeleteFile, WorkspaceEdit, WorkspaceChange, TextDocumentIdentifier, VersionedTextDocumentIdentifier, TextDocumentItem, MarkupKind, MarkupContent, CompletionItemKind, InsertTextFormat, CompletionItem, CompletionList, MarkedString, Hover, ParameterInformation, SignatureInformation, DocumentHighlightKind, DocumentHighlight, SymbolKind, SymbolInformation, DocumentSymbol, CodeActionKind, CodeActionContext, CodeAction, CodeLens, FormattingOptions, DocumentLink, SelectionRange, EOL, TextDocument, TextDocumentSaveReason */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!******************************************************************************************************************!*\
  !*** ./node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/jsonLanguageService.js ***!
  \******************************************************************************************************************/
/*! exports provided: TextDocument, Position, CompletionItem, CompletionList, Hover, Range, SymbolInformation, Diagnostic, TextEdit, FormattingOptions, MarkedString, getLanguageService, Color, ColorInformation, ColorPresentation, FoldingRange, FoldingRangeKind, SelectionRange, ErrorCode, ClientCapabilities */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getLanguageService", function() { return getLanguageService; });
/* harmony import */ var _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./_deps/vscode-languageserver-types/main.js */ "./node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/_deps/vscode-languageserver-types/main.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "TextDocument", function() { return _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_0__["TextDocument"]; });
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SelectionRange", function() { return _jsonLanguageTypes_js__WEBPACK_IMPORTED_MODULE_11__["SelectionRange"]; });
    ...
    return {
        ...
        format: function (d, r, o) {
            ...
            return Object(_jsonc_parser_main_js__WEBPACK_IMPORTED_MODULE_10__["format"])(d.getText(), range, options).map(function (e) {
                return _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_0__["TextEdit"].replace(_deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_0__["Range"].create(d.positionAt(e.offset), d.positionAt(e.offset + e.length)), e.content);
            });
        }
    };
}
...
/*!****************************************************************************************************************!*\
  !*** ./node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/jsonLanguageTypes.js ***!
  \****************************************************************************************************************/
/*! exports provided: Range, TextEdit, Color, ColorInformation, ColorPresentation, FoldingRange, FoldingRangeKind, SelectionRange, ErrorCode, ClientCapabilities */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../_deps/vscode-languageserver-types/main.js */ "./node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/_deps/vscode-languageserver-types/main.js");
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
    ...
    JSONDocument.prototype.validate = function (textDocument, schema) {
        if (this.root && schema) {
            ...
            return validationResult.problems.map(function (p) {
                var range = _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_4__["Range"].create(textDocument.positionAt(p.location.offset), textDocument.positionAt(p.location.offset + p.location.length));
                return _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_4__["Diagnostic"].create(range, p.message, p.severity, p.code);
            });
        }
        return null;
    };
        ...
        if (Array.isArray(schema.type)) {
            if (!schema.type.some(matchesType)) {
                validationResult.problems.push({
                    ...
                    severity: _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_4__["DiagnosticSeverity"].Warning,
...
function parse(textDocument, config) {
            ...
            switch (token_1) {
                ...
                case 13 /* BlockCommentTrivia */:
                    if (Array.isArray(commentRanges)) {
                        commentRanges.push(_deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_4__["Range"].create(textDocument.positionAt(scanner.getTokenOffset()), textDocument.positionAt(scanner.getTokenOffset() + scanner.getTokenLength())));
                    }
                    break;
                case 15 /* Trivia */:
                case 14 /* LineBreakTrivia */:
    ...
    function _errorAtRange(message, code, startOffset, endOffset, severity) {
        if (severity === void 0) { severity = _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_4__["DiagnosticSeverity"].Error; }
        if (problems.length === 0 || startOffset !== lastProblemOffset) {
            var range = _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_4__["Range"].create(textDocument.positionAt(startOffset), textDocument.positionAt(endOffset));
            problems.push(_deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_4__["Diagnostic"].create(range, message, severity, code, textDocument.languageId));
    ...
    function _parseProperty(parent, keysSeen) {
        ...
        if (seen) {
            _errorAtRange(localize('DuplicateKeyWarning', "Duplicate object key"), _jsonLanguageTypes_js__WEBPACK_IMPORTED_MODULE_2__["ErrorCode"].DuplicateKey, node.keyNode.offset, node.keyNode.offset + node.keyNode.length, _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_4__["DiagnosticSeverity"].Warning);
            if (typeof seen === 'object') {
                _errorAtRange(localize('DuplicateKeyWarning', "Duplicate object key"), _jsonLanguageTypes_js__WEBPACK_IMPORTED_MODULE_2__["ErrorCode"].DuplicateKey, seen.keyNode.offset, seen.keyNode.offset + seen.keyNode.length, _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_4__["DiagnosticSeverity"].Warning);
            }
...
/* harmony import */ var _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../_deps/vscode-languageserver-types/main.js */ "./node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/_deps/vscode-languageserver-types/main.js");
...
var JSONCompletion = /** @class */ (function () {
    ...
    JSONCompletion.prototype.doComplete = function (document, position, doc) {
        ...
        if (node && (node.type === 'string' || node.type === 'number' || node.type === 'boolean' || node.type === 'null')) {
            overwriteRange = _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_5__["Range"].create(document.positionAt(node.offset), document.positionAt(node.offset + node.length));
        }
        else {
            ...
            overwriteRange = _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_5__["Range"].create(document.positionAt(overwriteStart), position);
        }
        var proposed = {};
        var collector = {
            add: function (suggestion) {
                ...
                if (!existing) {
                    ...
                    if (overwriteRange) {
                        suggestion.textEdit = _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_5__["TextEdit"].replace(overwriteRange, suggestion.insertText);
                    }
            ...
            if (node && node.type === 'object') {
                ...
                properties.forEach(function (p) {
                    if (!currentProperty || currentProperty !== p) {
                        proposed[p.keyNode.value] = _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_5__["CompletionItem"].create('__');
                    }
                });
                ...
                if ((!schema && currentWord.length > 0 && document.getText().charAt(offset - currentWord.length - 1) !== '"')) {
                    collector.add({
                        kind: _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_5__["CompletionItemKind"].Property,
                        label: _this.getLabelForValue(currentWord),
                        insertText: _this.getInsertTextForProperty(currentWord, null, false, separatorAfter_1),
                        insertTextFormat: _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_5__["InsertTextFormat"].Snippet, documentation: '',
                    });
                    ...
                    Object.keys(schemaProperties_1).forEach(function (key) {
                        ...
                        if (typeof propertySchema === 'object' && !propertySchema.deprecationMessage && !propertySchema.doNotSuggest) {
                            var proposal = {
                                ...
                                insertTextFormat: _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_5__["InsertTextFormat"].Snippet,
    ...
    JSONCompletion.prototype.addDollarSchemaCompletions = function (separatorAfter, collector) {
        ...
        schemaIds.forEach(function (schemaId) { return collector.add({
            kind: _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_5__["CompletionItemKind"].Module,
    ...
    JSONCompletion.prototype.getSuggestionKind = function (type) {
        ...
        if (!type) {
            return _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_5__["CompletionItemKind"].Value;
        }
        switch (type) {
            case 'string': return _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_5__["CompletionItemKind"].Value;
            case 'object': return _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_5__["CompletionItemKind"].Module;
            case 'property': return _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_5__["CompletionItemKind"].Property;
            default: return _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_5__["CompletionItemKind"].Value;
        }
    };
    ...
    JSONCompletion.prototype.fromMarkup = function (markupString) {
        if (markupString && this.doesSupportMarkdown()) {
            return {
                kind: _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_5__["MarkupKind"].Markdown,
                value: markupString
            };
        }
        return undefined;
    ...
    JSONCompletion.prototype.doesSupportMarkdown = function () {
        if (!Object(_utils_objects_js__WEBPACK_IMPORTED_MODULE_4__["isDefined"])(this.supportsMarkdown)) {
            ...
            this.supportsMarkdown = completion && completion.completionItem && Array.isArray(completion.completionItem.documentationFormat) && completion.completionItem.documentationFormat.indexOf(_deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_5__["MarkupKind"].Markdown) !== -1;
        }
...
/* harmony import */ var _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../_deps/vscode-languageserver-types/main.js */ "./node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/_deps/vscode-languageserver-types/main.js");
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
var JSONDocumentSymbols = /** @class */ (function () {
                        ...
                        for (var _i = 0, _a = item.properties; _i < _a.length; _i++) {
                            ...
                            if (property.keyNode.value === 'key') {
                                if (property.valueNode) {
                                    if (property.valueNode) {
                                        var location = _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_3__["Location"].create(document.uri, getRange(document, item));
                                        result_1.push({ name: _parser_jsonParser_js__WEBPACK_IMPORTED_MODULE_0__["getNodeValue"](property.valueNode), kind: _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_3__["SymbolKind"].Function, location: location });
                                    }
                                    return;
                                }
                            }
        ...
        var collectOutlineEntries = function (result, node, containerName) {
            if (node.type === 'array') {
                ...
                node.properties.forEach(function (property) {
                    var location = _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_3__["Location"].create(document.uri, getRange(document, property));
                        ...
                        for (var _i = 0, _a = item.properties; _i < _a.length; _i++) {
                            ...
                            if (property.keyNode.value === 'key') {
                                if (property.valueNode) {
                                    ...
                                    result_2.push({ name: _parser_jsonParser_js__WEBPACK_IMPORTED_MODULE_0__["getNodeValue"](property.valueNode), kind: _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_3__["SymbolKind"].Function, range: range, selectionRange: selectionRange });
                                }
                                return;
                            }
                        }
    ...
    JSONDocumentSymbols.prototype.getSymbolKind = function (nodeType) {
        switch (nodeType) {
            case 'object':
                return _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_3__["SymbolKind"].Module;
            case 'string':
                return _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_3__["SymbolKind"].String;
            case 'number':
                return _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_3__["SymbolKind"].Number;
            case 'array':
                return _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_3__["SymbolKind"].Array;
            case 'boolean':
                return _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_3__["SymbolKind"].Boolean;
            default: // 'null'
                return _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_3__["SymbolKind"].Variable;
        }
    };
    ...
    JSONDocumentSymbols.prototype.getColorPresentations = function (document, doc, color, range) {
        ...
        result.push({ label: label, textEdit: _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_3__["TextEdit"].replace(range, JSON.stringify(label)) });
        return result;
    };
...
function getRange(document, node) {
    return _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_3__["Range"].create(document.positionAt(node.offset), document.positionAt(node.offset + node.length));
}
        ...
        switch (token) {
            ...
            case 13 /* BlockCommentTrivia */: {
                ...
                if (scanner.getTokenError() === 1 /* UnexpectedEndOfComment */ && startLine + 1 < document.lineCount) {
                    scanner.setPosition(document.offsetAt(_deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_0__["Position"].create(startLine + 1, 0)));
                }
                else {
...
/* harmony import */ var _parser_jsonParser_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../parser/jsonParser.js */ "./node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/parser/jsonParser.js");
/* harmony import */ var _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../_deps/vscode-languageserver-types/main.js */ "./node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/_deps/vscode-languageserver-types/main.js");
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
var JSONHover = /** @class */ (function () {
    ...
    JSONHover.prototype.doHover = function (document, position, doc) {
        ...
        var hoverRange = _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_1__["Range"].create(document.positionAt(hoverRangeNode.offset), document.positionAt(hoverRangeNode.offset + hoverRangeNode.length));
...
function getSelectionRanges(document, positions, doc) {
    function getSelectionRange(position) {
        ...
        for (var index = result.length - 1; index >= 0; index--) {
            current = _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_0__["SelectionRange"].create(result[index], current);
        }
        if (!current) {
    ...
    function newRange(start, end) {
        return _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_0__["Range"].create(document.positionAt(start), document.positionAt(end));
    }
...
var JSONValidation = /** @class */ (function () {
    ...
    JSONValidation.prototype.configure = function (raw) {
        if (raw) {
            ...
            this.commentSeverity = raw.allowComments ? void 0 : _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_1__["DiagnosticSeverity"].Error;
        }
    };
    JSONValidation.prototype.doValidation = function (textDocument, jsonDocument, documentSettings, schema) {
        ...
        var getDiagnostics = function (schema) {
            var trailingCommaSeverity = documentSettings ? toDiagnosticSeverity(documentSettings.trailingCommas) : _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_1__["DiagnosticSeverity"].Error;
            ...
            if (schema) {
                if (schema.errors.length && jsonDocument.root) {
                    ...
                    if (property && property.keyNode.value === '$schema') {
                        ...
                        var range = _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_1__["Range"].create(textDocument.positionAt(node.offset), textDocument.positionAt(node.offset + node.length));
                        addProblem(_deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_1__["Diagnostic"].create(range, schema.errors[0], _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_1__["DiagnosticSeverity"].Warning, _jsonLanguageTypes_js__WEBPACK_IMPORTED_MODULE_2__["ErrorCode"].SchemaResolveError));
                    }
                    else {
                        var range = _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_1__["Range"].create(textDocument.positionAt(astRoot.offset), textDocument.positionAt(astRoot.offset + 1));
                        addProblem(_deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_1__["Diagnostic"].create(range, schema.errors[0], _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_1__["DiagnosticSeverity"].Warning, _jsonLanguageTypes_js__WEBPACK_IMPORTED_MODULE_2__["ErrorCode"].SchemaResolveError));
                    }
                }
                else {
            ...
            if (typeof commentSeverity === 'number') {
                ...
                jsonDocument.comments.forEach(function (c) {
                    addProblem(_deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_1__["Diagnostic"].create(c, message_1, commentSeverity, _jsonLanguageTypes_js__WEBPACK_IMPORTED_MODULE_2__["ErrorCode"].CommentNotPermitted));
                });
            }
            return diagnostics;
        };
...
function schemaAllowsComments(schemaRef) {
    if (schemaRef && typeof schemaRef === 'object') {
        if (Object(_utils_objects_js__WEBPACK_IMPORTED_MODULE_4__["isBoolean"])(schemaRef.allowComments)) {
        ...
        if (schemaRef.allOf) {
            for (var _i = 0, _a = schemaRef.allOf; _i < _a.length; _i++) {
                ...
                if (Object(_utils_objects_js__WEBPACK_IMPORTED_MODULE_4__["isBoolean"])(allow)) {
                    return allow;
                }
            }
        }
...
function schemaAllowsTrailingCommas(schemaRef) {
    if (schemaRef && typeof schemaRef === 'object') {
        if (Object(_utils_objects_js__WEBPACK_IMPORTED_MODULE_4__["isBoolean"])(schemaRef.allowsTrailingCommas)) {
...
function toDiagnosticSeverity(severityLevel) {
    switch (severityLevel) {
        case 'error': return _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_1__["DiagnosticSeverity"].Error;
        case 'warning': return _deps_vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_1__["DiagnosticSeverity"].Warning;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(process) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setUriThrowOnMissingScheme", function() { return setUriThrowOnMissingScheme; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "URI", function() { return URI; });
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
